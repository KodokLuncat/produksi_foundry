...
<html>
    <head>
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url('assets/icon/MAV.ico')?>">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Produksi Foundry</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>PRODUKSI</b> FOUNDRY</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <button type="submit" class="btn bg-navy btn-block btn-flat"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</button>
                    </div>
                    <!--<div class="col-xs-6">
